...
export const themes: { [key: string]: ThemeType } = {
  casual: {
    ...
    'bs-new-convo-text-color': '#ffffff',
    'bs-new-convo-text-color-hover': 'white',
    'bs-new-convo-border-color': 'white',
    'bs-new-convo-border-color-hover': 'white',
    'bs-new-convo-bg-color-hover': 'linear-gradient(90deg, hsl(338, 75%, 67%) 0%, hsl(251, 44%, 65%) 100%)',
